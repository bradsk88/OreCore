...
public class OreCoreOverworldGen {
	...
	public void generate() {
		...
		doGenerateOre(OreCoreItems.bauxiteGravel, 0, Aluminum.BAUXITE_TOP_LEVEL, Aluminum.BAUXITE_GRAVEL_VEIN_SIZE, OreCoreItems.bauxite);
		
		doGenerateOre(OreCoreItems.copper, 0, Copper.COPPER_TOP_LEVEL, Copper.COPPER_VEIN_SIZE);
		doGenerateOre(OreCoreItems.copperGravel, 0, Copper.COPPER_GRAVEL_TOP_LEVEL, Copper.COPPER_GRAVEL_VEIN_SIZE, Blocks.gravel);
		doGenerateOre(OreCoreItems.copperInferior, 0, Copper.COPPER_INFERIOR_TOP_LEVEL, Copper.COPPER_INFERIOR_VEIN_SIZE);
		
		doGenerateOre(OreCoreItems.goldGravel, 0, Gold.GOLD_GRAVEL_TOP_LEVEL, Gold.GOLD_GRAVEL_VEIN_SIZE, Blocks.gravel);
		doGenerateOre(OreCoreItems.goldInferior, 0, Gold.GOLD_INFERIOR_TOP_LEVEL, Gold.GOLD_INFERIOR_VEIN_SIZE);
		
		doGenerateOre(OreCoreItems.ironGravel, 0, Iron.IRON_GRAVEL_TOP_LEVEL, Iron.IRON_GRAVEL_VEIN_SIZE, Blocks.gravel);
		...
		doGenerateOre(OreCoreItems.nickelGravel, 0, Nickel.NICKEL_GRAVEL_TOP_LEVEL, Nickel.NICKEL_GRAVEL_VEIN_SIZE, Blocks.gravel);
		...
		doGenerateOre(OreCoreItems.osmiumGravel, 0, Osmium.OSMIUM_GRAVEL_TOP_LEVEL, Osmium.OSMIUM_GRAVEL_VEIN_SIZE, Blocks.gravel);
		...
		doGenerateOre(OreCoreItems.silverGravel, 0, Silver.SILVER_GRAVEL_TOP_LEVEL, Silver.SILVER_GRAVEL_VEIN_SIZE, Blocks.gravel);
		...
		doGenerateOre(OreCoreItems.tinGravel, 0, Tin.TIN_GRAVEL_TOP_LEVEL, Tin.TIN_GRAVEL_VEIN_SIZE, Blocks.gravel);
		doGenerateOre(OreCoreItems.tinInferior, 0, Tin.TIN_INFERIOR_TOP_LEVEL, Tin.TIN_INFERIOR_VEIN_SIZE);
		
		//Titanium Sources
		doGenerateOre(OreCoreItems.rutile, 0, Titanium.RUTILE_TOP_LEVEL, Titanium.RUTILE_VEIN_SIZE, Blocks.sand);
		doGenerateOre(OreCoreItems.rutileInferior, 0, Titanium.RUTILE_INFERIOR_TOP_LEVEL, Titanium.RUTILE_INFERIOR_VEIN_SIZE, Blocks.sand);
		doGenerateOre(OreCoreItems.ilmenite, 0, Titanium.ILMENITE_TOP_LEVEL, Titanium.ILMENITE_VEIN_SIZE);
		doGenerateOre(OreCoreItems.ilmeniteInferior, 0, Titanium.ILMENITE_INFERIOR_TOP_LEVEL, Titanium.ILMENITE_INFERIOR_VEIN_SIZE);
		
		doGenerateOre(OreCoreItems.zinc, 0, Zinc.ZINC_TOP_LEVEL, Zinc.ZINC_VEIN_SIZE);
		doGenerateOre(OreCoreItems.zincGravel, 0, Zinc.ZINC_GRAVEL_TOP_LEVEL, Zinc.ZINC_GRAVEL_VEIN_SIZE, Blocks.gravel);
		doGenerateOre(OreCoreItems.zincInferior, 0, Zinc.ZINC_INFERIOR_TOP_LEVEL, Zinc.ZINC_INFERIOR_VEIN_SIZE);
	}

	private void doGenerateOre(Block ore, int minLayer, int maxLayer, int veinSize, Block destination) {
		for (int i = 0; i < 25; i++) {
	...
	private void doGenerateOre(Block ore, int minLayer, int maxLayer, int veinSize) {
		doGenerateOre(ore, minLayer, maxLayer, veinSize, Blocks.stone);
	}
