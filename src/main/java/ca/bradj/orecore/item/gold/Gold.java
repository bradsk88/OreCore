...
public class Gold {
	...
	public static void init() {
		OreCoreItems.goldDust = OreCoreItems.registerItem(new GoldDust(IDs.GOLD_DUST_ID), GOLD_DUST_NAME);

		OreDictionary.registerOre(GOLD_DUST_DICT, OreCoreItems.goldDust);
		
		OreCoreItems.addSmelting(OreCoreItems.goldDust, Items.gold_ingot, 1);
	}
